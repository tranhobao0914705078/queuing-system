            ...
            <div className={styles.Flex_input}>
                <div className={styles.inputLeft}>
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="idDevice" value="Nguyen Van A" aria-describedby="emailHelp" placeholder="Nhập họ tên" />
                    </div>
                    <div className="form-group">
                        <label className={styles.labelName} htmlFor="nameDevice">Số điện thoại <span>*</span></label>
                        <input type="text" className="form-control" id="nameDevice" value="0902345678" aria-describedby="emailHelp" placeholder="Nhập số điện thoại" />
                    </div>
                    <div className="form-group">
                        <label className={styles.labelName} htmlFor="ipAddress">Email <span>*</span></label>
                        <input type="email" className="form-control" id="ipAddress" value="NguyenA154@gmail.com" aria-describedby="emailHelp" placeholder="Nhập Email" />
                    </div>
                    <div className="form-group">
                ...
                <div className={styles.inputRight}>
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="userName" value="tuyetnguyen123" aria-describedby="emailHelp" placeholder="Nhập tên đăng nhập" />
                    </div>
                    <div className="form-group">
                        ...
                        <input type={setInputTypePassword} value='123456789' className="form-control" id="userPassword" aria-describedby="emailHelp" placeholder="Nhập mật khẩu" />
                    </div>
                    <div className="form-group">
                        ...
                        <input type={setInputTypeConfirm} value='123456789' className="form-control" id="userPassword" aria-describedby="emailHelp" placeholder="Nhập lại mật khẩu" />
                    </div>
                    <div className="form-group">
